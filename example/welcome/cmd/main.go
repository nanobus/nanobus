...
import (
	...
	welcome "github.com/nanobus/nanobus/example/welcome"
	"github.com/nanobus/nanobus/example/welcome/pkg/translator"
)
...
func main() {
	...
	s := welcome.New(translator.New(invoker))

	translator.InboudHandlers{
		GreetCustomer: s.GreetCustomer,
